...
new _card("Паразит", "", 2, {name:'parasite', value: true}),
...
new _card("Хищник", "", 1, {name:'carnivorous', value: true}),
new _card("Топотун", "", 0, {name:'stomper', value: true}),
new _card("Спячка", "", 0, {name:'hibernation', value: true}),
new _card("Ядовитое", "", 0, {name:'poisonous', value: true}),
];
export let plants = [
